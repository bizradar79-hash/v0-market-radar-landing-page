...
export default function WhatsAppButton() {
  // Start hidden to avoid SSR/CSR flash; reveal in useEffect once we know
  // localStorage state.
  ...
  useEffect(() => {
    try {
      ...
      /* localStorage blocked — still show the button */
    }
    setVisible(true)
  }, [])
  ...
  return (
    <div
      style={{
        ...
        bottom: 24,
        right: 24,
        zIndex: 9998, // below modals (which sit higher), above page content
        display: 'flex',
        alignItems: 'center',
